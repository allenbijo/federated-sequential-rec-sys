...
def preprocess(fname):
    ...
    file_path = f'/home/reuben/reuben_code/Pytorch/LLM-Rec-Sys/FedSasrec/data/amazon/{fname}.json.gz'
    ...
    f = open(f'/home/reuben/reuben_code/Pytorch/LLM-Rec-Sys/FedSasrec/data/amazon/meta_{fname}.json', 'r')
    ...
    with open(f'/home/reuben/reuben_code/Pytorch/LLM-Rec-Sys/FedSasrec/data/amazon/{fname}_text_name_dict.json.gz', 'wb') as tf:
    ...
    f = open(f'/home/reuben/reuben_code/Pytorch/LLM-Rec-Sys/FedSasrec/data/amazon/{fname}.txt', 'w')
